package com.elcatrin.app_delivery.GoogleMaps
...
class CurrentLocationOnMap : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /* Esta parte no la necesitamos acá, sino que abajo
    ...
    //Y en esta verificamos si se nos dieron los permisos o no
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        //Esto no lo necesito ya que es una ubicación codificada
        ...
        mMap.setOnMarkerDragListener(object: GoogleMap.OnMarkerDragListener {
            ...
            override fun onMarkerDragEnd(p0: Marker?) {
                ...
                if(currentMarker != null)
                    currentMarker?.remove() //Asi que lo remueve
